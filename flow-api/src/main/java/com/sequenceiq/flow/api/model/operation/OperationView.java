...
public class OperationView implements Serializable {
    ...
    private Integer expectedNumberOfFlows = DEFAULT_EXPECTED_NUMBER_OF_OPERATIONS;
    ...
    public Integer getExpectedNumberOfFlows() {
        return expectedNumberOfFlows;
    }

    public void setExpectedNumberOfFlows(Integer expectedNumberOfFlows) {
        this.expectedNumberOfFlows = expectedNumberOfFlows;
    }
}

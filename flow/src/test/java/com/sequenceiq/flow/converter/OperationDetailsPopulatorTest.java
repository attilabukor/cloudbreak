...
public class OperationDetailsPopulatorTest {
    ...
    public void testCreateOperationView() {
        ...
        OperationFlowsView operationFlowsView = new OperationFlowsView(OperationType.PROVISION, flowProgressResponseMap, List.of(DUMMY_CLASS));
        // WHEN
    ...
    public void testCreateOperationViewWithPendingState() {
        ...
        assertEquals(OperationProgressStatus.PENDING, operationView.getProgressStatus());
    }

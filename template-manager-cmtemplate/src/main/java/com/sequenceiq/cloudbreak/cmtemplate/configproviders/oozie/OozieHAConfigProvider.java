...
public class OozieHAConfigProvider implements CmTemplateComponentConfigProvider {
    ...
    private static Optional<String> oozieFQDN(TemplatePreparationObject source) {
        ...
        if (generalClusterConfigs != null && generalClusterConfigs.getInternalLoadBalancerEndpoint().isPresent()) {
            return generalClusterConfigs.getInternalLoadBalancerEndpoint();
        }
